...
export default function DataMeja() {
    return (
        <Card className="w-full overflow-hidden">
            <CardHeader>
                <CardTitle>Data Meja</CardTitle>
                <CardDescription>Tamu Mempelai Pria dan Wanita Per Meja</CardDescription>
            </CardHeader>
            <CardContent className="flex items-start justify-start gap-10 flex-wrap">
                <Card className="w-[300px] h-[300px] flex flex-col items-center justify-center">
                    <CardHeader className="text-center">
                        <CardDescription>Kelompokkan meja tamu undangan pernikahan</CardDescription>
                    </CardHeader>
