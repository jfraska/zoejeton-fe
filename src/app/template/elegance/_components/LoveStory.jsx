  ...
  return (
    ...
    >
      <div className="bg-[#EEEEEE] rounded-2xl overflow-hidden shadow-lg max-w-sm p-4">
        <img src="/templates/elegance/love-story.png" alt="love story" className="rounded-2xl"/>
          <div className="p-6">
            <h1 className={`${Selina.className} text-6xl text-gray-800 mb-4`}>Love Story</h1>
            <p className={`${Catamaran.className} text-gray-600 mb-6`}>
            ...
            <a href="#" className={`${Catamaran.className} flex items-center justify-center text-black hover:text-gray-500`}>
