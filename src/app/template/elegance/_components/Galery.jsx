...
export default function Galery() {
  return (
    <section className="relative flex flex-col w-full h-fit px-5 py-10 items-center mx-auto bg-[#333333]">
      <div className="flex gap-3 justify-around mb-4 h-20">
        <h2 className={`${Selina.className} text-white text-8xl`}>OUR</h2>
        <img src="/templates/elegance/gallery.png" alt="" className="w-48 rounded-2xl" />
      </div>
