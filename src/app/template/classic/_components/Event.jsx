...
export default function Event() {
  return (
    <section
      className="bg-white flex flex-col items-center justify-center min-h-screen space-y-8 py-10"
      name="event"
    >
      <div className="rounded-[100px] overflow-hidden shadow-lg max-w-sm h-[352px] text-center">
        <div className="relative">
          <img src="/templates/classic/event.png" alt="Akad Nikah Image" className="w-full bg-cover" />
          <div className="absolute inset-0 flex flex-col items-center justify-around pt-3 pb-5">
      ...
      <div className="rounded-[100px] overflow-hidden shadow-lg max-w-sm h-[352px] text-center">
        <div className="relative">
          <img src="/templates/classic/event.png" alt="Resepsi Image" className="w-full bg-cover" />
          <div className="absolute inset-0 flex flex-col items-center justify-around pt-3 pb-5">
