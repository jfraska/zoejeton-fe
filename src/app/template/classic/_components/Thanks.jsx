...
export default function Thanks() {
  return (
    <Section
      ...
      id="thanks"
    >
      <div className="flex flex-col items-start justify-start gap-5 pt-20 pl-7 text-white">
      ...
      <div className="absolute bottom-5 inset-x-0 w-full text-center text-white">
