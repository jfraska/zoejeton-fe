...
export default function Couple() {
  return (
    <section
      className="relative bg-white flex items-center justify-center min-h-screen px-5"
      name="card"
    >
      <div className="flex space-y-8 pb-10">
        <img src="/templates/classic/decor-bl.png" alt="decor bl" className="z-0 w-52 absolute top-0 left-0 transform scale-y-[-1]" />
        <div className="flex-col z-10 rounded-[100px] pl-5 pt-10 pb-4 w-96 h-[850px] aspect-square bg-cover bg-no-repeat" style={{
