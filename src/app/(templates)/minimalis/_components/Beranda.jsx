...
export default function Beranda() {
  return (
    <section className="relative w-full h-screen bg-[#9D9E9A]" id="beranda">
      ...
      <div className="absolute bottom-[20%] inset-x-0 flex gap-2 justify-around items-center px-6 text-center text-2xl">
