...
export default function Galery() {
  return (
    <Section
      className="relative flex flex-col w-full h-fit px-5 py-10 items-center mx-auto bg-secondary-bg text-secondary-text"
      id="galery"
    >
      ...
      <div className="flex items-center justify-between w-full gap-5">
        ...
        <div className="relative flex w-full flex-col items-center justify-between gap-5 mb-4 py-5">
          <Editable
      ...
      <Editable type="link" field="link" section="gift" className="mt-5">
        <a
          href="/"
          target="_blank"
          className={`${Catamaran.className} w-32 flex items-center justify-center bg-accent-bg text-accent-text p-2 rounded-xl`}
        >
