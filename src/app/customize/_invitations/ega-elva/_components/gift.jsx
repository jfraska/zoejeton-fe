...
export default function Gift() {
  const handleCopy = () => {
    navigator.clipboard.writeText("3200765353").then(
      () => {
            ...
            <CollapsibleContent>
              <div className="flex w-full rounded-xl mt-5 p-4 bg-white shadow-lg text-gray-900 backdrop-filter backdrop-blur-md bg-opacity-60">
                <div className="w-full flex flex-col gap-1 ">
                  <h1 className="text-xl font-medium">Bank BCA</h1>
                  <h2 className="text-lg mt-2">3200765353</h2>
                  <h2>a.n. Ega Chandra Pratama</h2>
                </div>
                <Button
