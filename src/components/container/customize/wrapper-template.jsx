...
export function Main({ children, className }) {
  ...
  return (
    <div className={`${className} h-screen ml-auto lg:max-w-lg w-full`}>
      {children}
      <Template />
    </div>
  );
...
export function Section({ children, className, id, styles }) {
  ...
  return (
    <section id={id} className={`${background && "relative"} w-full`}>
      {background && (
        <Image
          fill
          priority
...
export function Cover({ children, className }) {
  ...
  return (
    <div
      className={`fixed right-[32rem] inset-y-0 left-0 lg:block hidden`}
      id="cover"
    >
      {background && (
        <Image
...
export function Floating({ children, className, id }) {
  ...
  return (
    <div id={id} className={`${className} fixed`}>
      {children}
    </div>
  );
}
